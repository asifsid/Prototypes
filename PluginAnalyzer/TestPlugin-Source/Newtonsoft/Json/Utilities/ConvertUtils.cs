...
namespace Newtonsoft.Json.Utilities
{
	internal static class ConvertUtils
	{
		...
		{
			MethodInfo methodInfo = t.TargetType.GetMethod("op_Implicit", new Type[1] { t.InitialType }) ?? t.TargetType.GetMethod("op_Explicit", new Type[1] { t.InitialType });
			if (methodInfo == null)
			{
				return null;
			}
			...
			for (; i < num; i++)
			{
				...
				if (num7 < 29)
				{
					if (num7 == 28)
					{
						...
						if (!flag4.HasValue)
						{
							flag3 = num5 > 7922816251426433759L || (num5 == 7922816251426433759L && (num6 > 354395033 || (num6 == 354395033 && c > '5')));
							bool? flag5 = flag3;
							valueOrDefault = flag5.GetValueOrDefault();
						}
						else
						{
					...
					if (num7 < 19)
					{
						num5 = num5 * 10 + (ulong)(c - 48);
					}
					else
					{
						num6 = num6 * 10 + (ulong)(c - 48);
					}
					num7++;
					continue;
				}
